...
def read_langs(file_name, max_line = None):
    ...
    logging.info('wet:{},cal:{},nal:{}'.format(counter_wet/len(data),counter_cal/len(data),counter_nal/len(data)))
...
def get_seq(pairs,lang,batch_size,type,max_len):   
    ...
    logging.info('front 95 percent of lengths:{}'.format(np.percentile(lengths,95)))
    return data_loader
